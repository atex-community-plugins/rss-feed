...
public class RssFeedRenderController extends RssImageController {
    ...
    public void populateModelAfterCacheKey(RenderRequest request, TopModel m, CacheInfo cacheInfo,
        ...
        for (Model content : contents) {
            ...
            if (articleOrQueue instanceof Rssable) {
                lastBuildDate = prepareFeedItem((Rssable) articleOrQueue, rssItems, lastBuildDate);
    ...
    protected Date prepareFeedItem(Rssable rssable, List<RssItem> rssItems, Date lastBuildDate) {
        ...
        RssItem rssItem = new RssItem(appendCDATA, appendCDATA2, pubDate, contentIdString, rssable.getItemParentIds());
